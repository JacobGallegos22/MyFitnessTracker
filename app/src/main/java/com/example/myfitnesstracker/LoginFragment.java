...
public class LoginFragment extends Fragment {
  ...
  public void onResume() {
    super.onResume();
    register = getView().findViewById(R.id.registerForAccount);
    email = getView().findViewById(R.id.email);
    password = getView().findViewById(R.id.password);
    loginButton = getView().findViewById(R.id.loginBtn);
  ...
  public void login(String email, final String password) {
    //Send get and recieve the input
    ...
    HttpGet httpGet = new HttpGet(getContext(), path, httpListener);
    httpGet.execute("");
