...
public class AddFoodFragment extends Fragment {
  ...
  public void onResume() {
    super.onResume();
    mCalories = getView().findViewById(R.id.calories);
    addFootButton = getView().findViewById(R.id.addFoodBtn);

    addFootButton.setOnClickListener(new View.OnClickListener() {
      @Override
